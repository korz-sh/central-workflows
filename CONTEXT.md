...
(`web-api/.github/workflows/ci.yml` — "korz-sh/central-workflows/.github/workflows/ci-dotnet.yml@main").
...
| | `ci-dotnet` | 1: web-api (entitlement-api lo dejó el 2026-09-03 y rbac-api el 2026-09-04, al borrar su C#) |
...
- **Anything at all** → remember there is no staging. The merge is the release, to 12 repos that
  ...
  `web-api/.github/workflows/ci.yml` — "korz-sh/central-workflows/.github/workflows/ci-dotnet.yml@main".
  (Las dos citas apuntaban a entitlement-api hasta el 2026-09-03 y a rbac-api hasta el 2026-09-04;
  los dos repos borraron su C# y dejaron de consumir `ci-dotnet`. Medido con
  `grep -rln "ci-dotnet.yml@" */*/.github/workflows/`: queda **un** consumidor, web-api.)
